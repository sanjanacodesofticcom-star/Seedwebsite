...
export const metadata = {
  title: 'Terms of Service | GetAseed',
  description: 'GetAseed Terms of Service. Review our 7-day free onboarding, transparent pricing, and Meta API terms.',
};

export default function TermsOfServicePage() {
  const data = legalPagesData['terms-of-service'];
